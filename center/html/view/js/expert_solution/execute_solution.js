...
function execute(){
	if(confirm("你确定要提交吗？")){
	$.post('../../../..//modules/php/action/page/projectapp/projectapp.act.php?action=execute_solution&name=项目实施方案',function(result){
		if(result['code']!=0){
			alert("提交成功");
...
/*			if(i==1){
	...
	$('.check').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../website/html/view/template/check_opinion.php?table_status='+table_status+'&user_type='+user_type+"&table_name='项目实施方案'");
	});
	//文件上传
