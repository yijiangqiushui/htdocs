...
//	alert("value="+value+"  name="+name);
	if(value==1){
		// 通过
		$.post('/modules/php/action/page/projectapp/projectapp.act.php?action=execute&name=北京市通州区科技计划项目实施方案',function(result){
			if(result['code']!=0){
...
/*			if(i==1){
	...
	$('.org_info').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/org_info.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.project_mean').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_meaning.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.work_base').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_status.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.project_target').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_target.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.project_content').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_content.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.tech_route').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_techway.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.project_plan').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_ann_plan.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.project_budget').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/total_fund.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.project_risk').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_risk.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.expect_manage').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_expert_form.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.recommend_plan').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_economy_effect.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.project_member').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_member.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.approve').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/project_opinion_promise.php?table_status='+table_status+'&user_type='+user_type);
	});
	$('.centercheck').bind('click',function(){
		$('.iframe iframe').attr('src','/center/php/action/page/check_opinion.php?table_status='+table_status+"&table_name='北京市通州区科技计划项目实施方案'"+'&user_type='+user_type);
	});
	//文件上传
	$('.imp_plan').bind('click',function(){
		$('.iframe iframe').attr('src','../../../../../../website/html/view/template/Projectapp/uploadFile.php?table_status='+table_status+'&user_type='+user_type);
	});
}
