...
<!--</div> default_left-->
	...
	<div region="west" split="true" title="申报阶段审核" style="width:300px;">
		...
		<ul style="padding-left:50px;">
			<li style="list-style-type:none;"><a href="/website/html/view/template/apply/attach_9/org_info.php?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;1.1 基本信息</a><span></span></li>
			...
			<li><a target="center" href="/center/php/action/page/check_opinion.php?status=<?php echo $table_status;?>&table_name='通州区支持科技企业孵化器大学科技园发展项目申报书'">审核意见</a></li>
		</ul>
	</div>
