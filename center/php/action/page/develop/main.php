...
<div class="easyui-panel" title="发展计划科项目列表" collapsible="false" resizable="false" border="false">
<table width="1286" >
...
include '../../../../common/php/lib/db.cls.php';
	  ...
	  $row_n = mysql_num_rows($result);
        for($i = 1; $i <=  $row_n;$i++){
            $project_dev = mysql_fetch_object($result);
            echo "<tr>";
            echo "<td align='center' height='30'>".$i."</td>";
            echo "<td align=center>".$project_dev->project_name."</td>";
            echo "<td align=center>".$project_dev->project_type."</td>";
            $sql_project = "Select * from project_type where name='$project_dev->project_type'";
            ...
            //项目阶段
            switch($project_dev->project_stage){
                case 1:
                    $stage = "立项阶段";break;
                case 2:
                    $stage = "实施阶段";break;
            ...
            $project_id = $project_dev->project_id;
            $sql_table = "Select * from table_status where project_id = '$project_id' and project_stage = '$project_dev->project_stage'";
            ...
            echo "<td align=center><a href = '#' onclick=";" >审批</a></td>";
            echo "</tr>";
        }
