...
<div class="easyui-layout" style="width:100%;height:2500px;">
	<div region="west" split="true" title="申报阶段审核" style="width:300px;">
	    <h3>通州区支持创新平台建设项目申报书</h3>
		<ul style="padding-left:50px;">
			 <li><a href="/website/html/view/template/apply/attach_5/org_info.html?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;1.1 申报单位基本情况</a><span></span></li>
             <li><a target="center" href="/center/php/action/page/check_opinion.php?status=<?php echo $table_status;?>&table_name='通州区支持创新平台建设项目申报书'">审核意见</a></li>
		</ul>
	</div>
