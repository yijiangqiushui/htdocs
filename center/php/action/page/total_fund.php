...
<link
	href="../../../../website/html/view/css/total_fundf/total_fundf.css"
	rel="stylesheet" type="text/css" />
<script type="text/javascript"
	src="../../../html/view/js/user_project/total_fundf.js"></script>
</head>
			...
			<div class="menusNiframe">
				...
				<div class="menus">
					<ul>
						...
						<li class="menu menu-unselected fund">项目经费总决算表</li>
				...
				<div class="iframe">
					<iframe name="subframe" src="../../../../website/html/view/template/total_fund.php" frameborder="0"></iframe>
				</div>
			</div>
			<!--menusNiframe-->
		</div>
