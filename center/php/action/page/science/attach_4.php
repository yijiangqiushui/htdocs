...
$db = new DB();
  ...
  $sql = "Select * from table_status where project_id = '$project_id' and table_name = '通州区支持承担市级以上科技项目申报书' ";
...
<!-- <link href="/commotml/plugin/jquery-hlui-2.0/css/layout.css" rel="stylesheet" type="text/css" /> -->
...
<div class="menus">
  <h1>申报阶段</h1>
  <ul class="apply">
    <label>通州区支持承担市级以上科技项目申报书<span></span></label>
...
//                 echo "<li><a href=\"Projectapp/project_check_opinion.php?status=". $table_status."&table_name="."项目实施方案"."\"".">&nbsp;&nbsp;&nbsp;&nbsp;1.14 审核意见</a><span></span></li>";
                echo "<li><a href=..\..\"check_opinion.php?status=".$table_status."&table_name='通州区支持承担市级以上科技项目申报书'\">&nbsp;&nbsp;&nbsp;&nbsp;审核意见</a><span></span></li>";
...
//             echo "<li><a href=\"Projectapp/project_check_opinion.php?status=". $table_status."&table_name="."项目实施方案"."\"".">&nbsp;&nbsp;&nbsp;&nbsp;1.14 审核意见</a><span></span></li>";
    ...
    if($user_type == 0){
        if($table_status == 1 || $table_status == 3){
            echo "<h1>提交申请书</h1>";
            echo "<ul class='apply'>";
            echo "<li><a href='#' onclick='execute();'>&nbsp;&nbsp;&nbsp;&nbsp;通州区支持承担市级以上科技项目申报书</a></li>";
        }
    }
  ?>
