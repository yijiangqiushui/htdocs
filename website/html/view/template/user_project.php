            ...
            <table border="0" cellpadding="0" cellspacing="0" class="basic_info">
                <tr>
                    ...
                    <td width="" align="center">
                        <input type="text" id="business_id" name="business_id" readonly="readonly"/>
                    </td>
                ...
                <tr>
                    ...
                    <td width="300" align="center"><input type="text" id="project_engineer" name="project_engineer" readonly="readonly"/></td>   
                </tr>
                <tr>
                ...
                <tr>
                    <th width="125" class="border_none">开始时间</th>
                    <td width="300" align="center">

                        <input type="text" id="project_start" name="start_time" readonly="readonly"/></td>
                    <th width="125" class="border_none border_left_w">结束时间</th>
                    <td width="300" align="center">
                    <input type="text" id="project_end" name="end_time"  readonly="readonly"/></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div id="div4" class="table_content">
        <table border="0" cellpadding="0" cellspacing="0"  class="basic_info">
            ...
            for ($i = 1; $i <= $row_n; $i++) {
                ...
                //echo $row->last_modify.'0000000000';
                ...
                //if (($row->approval_time != null&& $project_stage!=0)||$row->table_status==3) {
                if (($row->approval_time != null)||$row->table_status==3) {
                ...
                $str = $sql_table['pdf_url'];
                    ...
                    /* $sql_check = "Select * from table_type_relative where project_type_id = $project_type and table_type_id = $row->table_name group by table_type_id";
                    $result_check = $db->Select($sql);
                    if($result_check[0]['not_check'] == 1){
                        echo '<center><strong>查 看</strong></a> | <a href="#" onclick= "printWord(' . "'" . $str . "'" .",".$row->table_status.",".$project_type.')"><strong>打 印</strong></a></center></td>';
