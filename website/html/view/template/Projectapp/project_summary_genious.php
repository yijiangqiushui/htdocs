...
<title>无标题文档</title>
 ...
 <link rel="stylesheet" type="text/css" href="../../../../../common/html/plugin/easyui/themes/icon.css"/>
    ...
    <script  src="../../../../../common/php/plugin/jquery-ui-1.11.4/jquery-2.1.0.min.js"></script>
    ...
    <script type="text/javascript" src="../../js/projectapp/project_summary_genious.js"></script>
    <style>
        tr:nth-child(odd) {
...
<form id="project_summary" method="post">
    <div style="margin: 40px 20px 40px 20px; max-width: 900px">
        ...
        <table style="border-color:#D1E4F3" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                <td colspan="4" class="" style="background-color:#7AB5ED;height:35px;font-size:14px;"><div style="font-weight: bold; line-height:30px;color:#FFF002;text-align: center;">申报信息</div></td>
            </tr>
                
            <tr>
                <th>申报人姓名</th>
                <td width="" colspan="3" align="center" style="">
                    <input type="text" id="genious_name" name="genious_name" />
                </td>
            </tr>
            <tr>
