...
<?php }else{ ?>
<script type="text/javascript" src="../../js/projectapp/project_content.js"></script>
    	...
    	<div class="project_content">
		    ...
		    <div class="table_content back-long">
				<div class="basic_info bg_blue">
					 <p class="title_top"><span>项目研究开发内容</span></p>
					 <p class="subtitle"><span class="stitle_num">1、</span><span class="stitle_name"></span>（<span class="stitle_tip">项目主要研发内容、关键技术及创新点，对完成项目目标和考核指标的重要性</span>）</p>
					 <div class="text_wrap">
