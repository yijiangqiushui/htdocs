...
<script type="text/javascript"
	src="../../js/projectapp/is_edit_common.js"></script>
<?php if(isset($_GET['is_edit'])&&$_GET['is_edit']){?>
<script type="text/javascript" src="../../js/projectapp/is_edit.js"></script>
<?php }else{ ?>
<script type="text/javascript"
	src="../../js/projectapp/task_pro_target.js"></script>
<script type="text/javascript"
	src="../../js/projectapp/is_edit_front.js"></script>
<?php }?>
		...
		<div class="project_content">
			...
			<div class="table_content back-long">
				<div class="basic_info bg_blue">
					...
					<div class="text_wrap">
						<textarea name="project_mission" id="project_mission"
					...
					<p class="subtitle">3、考核指标（考核指标应体现项目目标预期完成程度和水平，以及对项目各项研究开发内容预期完成情况的考核。指标体系应系统、完整，客观可检查；项目目标和考核指标应能够系统、完整地表达任务完成情况，具有成果的依附形式或载体，体现实际效果，可查、可测、可看。）</p>
					<div class="text_wrap">
