...
<?php }else{ ?>
<script type="text/javascript" src="../../js/projectapp/other_condition.js"></script>
...
<body>
	 <form id="other_condition_form" method="post">
    	<div class="project_content">
		    ...
		    <div class="table_content back-long">
				<div class="basic_info bg_blue">
					 <p class="title_top" style='height: 40px;'>其他条款</p>
					 <div class="text_wrap">
						<textarea id="other_condition" name="other_condition" class="text_content"></textarea>
					</div>
