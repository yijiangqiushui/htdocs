...
<?php }else{ ?>
<script type="text/javascript" src="../../js/projectapp/project_mean.js"></script>
...
<body>
    <form id="project_mean" method="post">
    	<div class="project_content">
			...
			<div class="table_content back-long">
				<div class="basic_info bg_blue">
					...
					<p class="title_top p-b10">项目的目的、意义及必要性</p>
					<p class="subtitle"><span class="stitle_num">1</span>、<span class="stitle_name">项目的目的、意义及必要性</span>（<span class="stitle_tip">&nbsp;&nbsp;</span>）</p>
					<div class="text_wrap">
