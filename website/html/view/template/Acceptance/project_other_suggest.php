...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" type="text/css"
		...
		<script type="text/javascript"
			src="../../js/acceptance/project_oth_suggest.js"></script>
...
<body>
<form id="project_oth_suggest" method="post" action="#">
...
<div class="table_content back-long">
				<div class="basic_info bg_blue">
					<p class="title_top p-b10">其它说明及存在问题</p>
					<div class="text_wrap">
						<textarea  name="project_other_suggest" id="project_other_suggest"  class="text_content" placeholder="1.其它说明
2.存在问题"></textarea>
					</div>
