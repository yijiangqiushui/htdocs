...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" type="text/css"
		...
		<script type="text/javascript"
			src="../../js/acceptance/project_summary.js"></script>
...
<div class="table_content back-long">
				<div class="basic_info bg_blue">
					<p class="title_top p-b10">任务目标</p>
					<div class="text_wrap">
						<textarea name="project_process"   datalength="1000"  id="project_process" class="text_content" placeholder="输入内容不多于1000字！" ></textarea>
