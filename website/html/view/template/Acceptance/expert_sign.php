...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="../../js/acceptance/expert_sign.js"></script>
    ...
    <body>
        <form id="appFm" method="post" action="#">
            <div class="project_content"/>
            <div class="table_title clearfix">
                <div class="title_pic left">验收专家信息填写</div>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="6" class="border_left_none"
                            ...
                            <div class="title_top p-b10">北京市通州区科技计划项目 <span id="project_name_span"> </span>验收专家信息</div>
                        </td>
                    </tr>

                    <tr>
                        <th><p align="center">项目名称</p></th>
                        <td colspan="3"><input name="project_name"
                                               datatype="chinese_characters" readonly/></td>
                        <!-- project_info -->
                        <th><p align="center">项目编号</p></th>
                        <td colspan="3"><input name="business_id" readonly/></td>
                        <!-- project_info -->
                    </tr>
                    <tr>
                        <th><p align="center">承担单位</p></th>
                        <td colspan="3"><input name="org_name" readonly/></td>
                        <!-- project_info -->
                        <th><p align="center">项目负责人</p></th>
                        <td colspan="3"><input name="project_leader"  
                                               datatype="chinese_characters"/></td>
                        <!-- project_info -->
                    </tr>
                    <tr>
                        <th><p align="center">所属资金专项名称</p></th>
                        <td colspan="3"><input name="project_money" /></td>
                        <th><p align="center">验收时间</p></th>
                        <td colspan="3"><input name="project_argtime" id="argument_time" class="dateplu" readonly/></td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td>
                            <table id="addtable">
                                ...
                                $sql = "Select * from experts where project_id= '$project_id'";
                                // echo $sql;
                                $db = new DB();
		...
		<option value='0'";
                                        ...
                                        echo "<td width='40' ><input type='button' value='删除' class='pointer'  onclick='delLine(this)'/></td>";
                                        echo "</tr>";
                                    }
                                } else {
                                    echo "<tr>";
                                    echo "<td width='110'><input type='text' name='expert_name[0]' /></td>";
                                    echo "<td width='267'><select type='text' name='expert_divide[0]' >
        ...
        <option value='0'>组长</option>
                    ...
                    <tr>
                        <th colspan="9" height="25"><input type="button" value="添加"
                                                           class='pointer'       onclick="addLine()"/></th>
                        <!-- 没有字段-->
                    </tr>
                </table>
