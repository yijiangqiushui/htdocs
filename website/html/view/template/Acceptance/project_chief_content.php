...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" type="text/css"
		...
		<script type="text/javascript"
			src="../../js/acceptance/project_chief_content.js"></script>
		<link rel="stylesheet" type="text/css" href="../../css/table.css"/>
			<link rel="stylesheet" type="text/css" href="../../css/button.css"/>
</head>  
<body>
<form id="project_chief_content" method="post" action="#">
...
<div class="table_content back-long">
				<div class="basic_info bg_blue">
					<p class="title_top p-b10">主要研发内容</p>
					<div class="text_wrap">
						<textarea name="project_chief_context" id="project_chief_context" class="text_content" placeholder="1.任务书规定的内容
2.实际完成情况"></textarea>
