...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" type="text/css"
		...
		<script type="text/javascript"
			src="../../js/acceptance/project_generalize_plan.js"></script>
		<link rel="stylesheet" type="text/css" href="../../css/table.css"/>
			<link rel="stylesheet" type="text/css" href="../../css/button.css"/>
</head>
<body>
 <form id="project_gen_plan" method="post" action="#">
...
<div class="table_content back-long">
				<div class="basic_info bg_blue">
					<p class="title_top p-b10">成果及推广应用计划</p>
					<div class="text_wrap">
						<textarea  name="project_generalize_plan" id="project_generalize_plan"  class="text_content"></textarea>
					</div>
