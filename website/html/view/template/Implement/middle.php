...
<head>
   ...
   <!--  <link rel="stylesheet" type="text/css"
    ...
    <script type="text/javascript" src="../../js/implement/middle.js"></script>
</head>
<body>
   ...
   <!--<div class="project_content">
        <div class="table_title clearfix">
         ...
         <div class="table_content back-long">
              <table cellspacing="0" cellpadding="0" style="border:0px;" class="basic_info">
                <tr>
                    <td colspan="4" class="border_left_none"  style="background-color:#7AB5ED;">
                        <div class="title_top p-b10">项目进展情况</div>
                    </td>
                </tr>
          
            <tr style="background-color:#D1E4F3 ">
           
                <td> <div class="text_wrap"><textarea name="project_process" id="project_process" class="text_content"
                              ></textarea> </div>
                </td>
...
<div class="table_content back-long">
				<div class="basic_info bg_blue">
					<p class="title_top p-b10">项目进展情况</p>
					<div class="text_wrap">
						<textarea name="project_process" id="project_process" class="text_content"></textarea>
