            ...
            <div class="project_content">
                ...
                <div class="table_content back-long">
                    <div class="basic_info bg_blue">
                        ...
                        <div class="subtitle" ><div>1、技术方案与技术路线（依据项目任务要求，结合国内外技术发展和本单位实际情况确定，论证前应充分分析和阐述技术方案与技术路线，对不同方案和路线加以比较和论证说明。）</div></div>
                        <div class="text_wrap">
                            <textarea id="tech_way" name="tech_way" class="text_content"></textarea>
                        </div>
                        <div class="subtitle" ><div>2、项目组织实施与管理措施（项目的组织管理和协调措施应能保障项目的正常实施；应能落实项目实施所需配套条件；项目负责人应能切实履行项目管理职责；应能落实项目任务所需的研究团队和配套仪器设备、经费等条件，有完善的科技管理制度。）</div></div>
                        <div class="text_wrap">
                            <textarea id="project_manage" name="project_manage" class="text_content"></textarea>
                        </div>
                        <div class="subtitle" ><div>3、项目委托任务（需另附委托或合作协议）（如有委托研究的任务，受托单位确保委托任务完成的措施；如有多家单位承担项目任务，阐明项目的任务分工及相应的目标和考核指标。）
                        </div></div>
                        <div class="text_wrap">
