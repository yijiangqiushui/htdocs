            ...
            <div class="project_content">
                ...
                <div class="table_content back-long">
                    <div class="basic_info bg_blue">
                        ...
                        <div class="subtitle" ><div>1、项目任务：（项目任务应明确科技工作在解决实际问题中的责任和完成工作的范围、界限，即项目全部工作和成果的整体描述。）</div></div>
                        <div class="text_wrap">
                            <textarea name="project_mission" id="project_mission" class="text_content"></textarea>
                        </div>
                        <div class="subtitle" ><div>2、项目目标：（项目目标内容应完整、明确，并能够考查项目完成的程度和实际效果。包括定性、定量两个部分，定性的内容应概括项目预期效果的几个方面，定量的内容应说明预期效果的程度和范围。）</div></div>
                        <div class="text_wrap">
                            <textarea name="project_aim" id="project_aim" class="text_content"></textarea>
                        </div>
                        <div class="subtitle" ><div>3、考核指标：（考核指标应体现项目目标预期完成程度和水平，以及对项目各项研究开发内容预期完成情况的考核。指标体系应系统、完整，客观可检查；项目目标和考核指标应能够系统、完整地表达任务完成情况，具有成果的依附形式或载体，体现实际效果，可查、可测、可看。）</div></div>
                        <div class="text_wrap">
