...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="../../../js/projectapp/honor_title.js"></script>

    </head>

    <body>
        <form id="honor_title" method="post">
            <div class="project_content">
                ...
                <div class="table_content back-long">
                    <div class="basic_info bg_blue">
                        ...
                        <p class="title_top p-b10"><?php $time = date("Y",time());echo ($time-1)?>年突出贡献及获得的荣誉称号情况</p>

                        <div class="text_wrap">
                            <textarea name="honor_title" id="" class="text_content"></textarea>
                        </div>
