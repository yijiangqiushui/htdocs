...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="../../../js/projectapp/work_product.js"></script>

    </head>

    <body>
        <form id="work_product" method="post">
            <div class="project_content">
                ...
                <div class="table_content back-long">
                    <div class="basic_info bg_blue">
                        ...
                        <p class="title_top p-b10"><?php $time = date("Y",time());echo ($time-1)?>年主要工作实绩</p>

                        <div class="text_wrap">
                            <textarea name="work_product" id="" class="text_content"></textarea>
                        </div>
