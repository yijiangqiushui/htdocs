                ...
                <div class="table_content back-long">
                    <table cellspacing="0" cellpadding="0" class="basic_info">
                        ...
                        <tr>
                            ...
                            <td colspan='2'><select id="org_sex" name="genious_sex">
...
<!--                             <td rowspan="4"><p>(1寸彩照)</p></td> -->
                        ...
                        <tr>
                            ...
                            <td colspan='2'>
								<select  class='year'  name='genious_year'>
								</select>
								<select class='month'  name='genious_month'>
								</select>
							</td>
                            <th><p align="center">民族</p></th>
                            <td colspan='2'><input name="genious_nation"  /></td>
                        </tr>
                        <tr>
                            <th><p align="center">党派</p></th>
                            <td colspan="2"><input name="genious_party"/></td>
                            <th><p align="center">籍贯</p></th>
                            <td colspan='2'><input name="genious_native"/></td>
                        </tr>
                        <tr>
                            <th><p align="center">学历</p></th>
                            <td colspan="2">
                                <select name="genious_edu">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input name="major_post"
                                                   /></td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2"><input name="genious_phone" datatype="telephone" placeholder="请输入手机号"/></td>
                        </tr>
                        <tr>
                            <th><p align="center">工作单位（企业名称）</p></th>
                            <td colspan="2"><input name="company_name"  readonly/></td>
                            <th><p align="center">注册时间</p></th>
                            <td colspan="2"><input name="register_time" id="regist_time" class="dateplu" readonly/></td>
                        </tr>
                        <tr>
                            <th><p align="center">是否为高新企业</p></th>
                            <td colspan="2">
                            <select name="high_tech" >
                                    <option value='是' >是</option>
                                    <option value='否'>否</option>
                         
                           </select>
                            <!--  <input name="is_hightec_prise" placeholder="正确格式：'是'，'否'"/>
                            	<input type="radio" name="is_hightec_prise" style="width:20px; height:20px; margin-left:10px;"  />是
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input name="email"  datatype="email" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><select name="corp_grade" >
                                ...
                                <td colspan="3"><input name="serving_time" id="serving_time"  class="dateplu" readonly="readonly"/></td>
                        </tr>
                        <tr>
                            <th><p align="center">职工总数</p></th>
                            <td><input name="work_force" datatype="number" placeholder="请输入整数"/></td>
                            <th><p align="center">大专以上人员数量</p></th>
                            <td><input name="college_num" datatype="number" placeholder="请输入整数"/></td>
                            <th><p align="center">研发人员数量</p></th>
                            <td><input name="research_num" datatype="number" placeholder="请输入整数"/></td>
                        </tr>
                        <tr>
                            <th rowspan="6"><p align="center">工作简历</p></th>
                            <td rowspan="6" colspan="6" >
<!--                             <div class='text_wrap' > -->
                            	<textarea  rows="6" cols="6"   name="job_resume" style="height: 100px; width: 98%; background-color: transparent;" ></textarea>
<!--                             </div> -->
                            </td>
                        </tr>
                    </table>
