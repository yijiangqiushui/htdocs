...
include '../../../../../../common/php/lib/db.cls.php';
  ...
  $sql = "Select * from table_status where project_id = '$project_id' and table_name = '通州区支持科技成果转化项目申报书' ";
...
<div class="menus">
  ...
  <ul class="apply">
    ...
    <li><a href="project_info.php?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;1.2 项目基本情况</a><span></span></li>
    <?php 
         if($user_type == 0){
            if($table_status > 2){
//                 echo "<li><a href=\"Projectapp/project_check_opinion.php?status=". $table_status."&table_name="."项目实施方案"."\"".">&nbsp;&nbsp;&nbsp;&nbsp;1.14 审核意见</a><span></span></li>";
                echo "<li><a href=..\..\"check_opinion.php?status=".$table_status."&table_name='通州区支持科技成果转化项目申报书'\">&nbsp;&nbsp;&nbsp;&nbsp;审核意见</a><span></span></li>";
...
//             echo "<li><a href=\"Projectapp/project_check_opinion.php?status=". $table_status."&table_name="."项目实施方案"."\"".">&nbsp;&nbsp;&nbsp;&nbsp;1.14 审核意见</a><span></span></li>";
    ...
    if($user_type == 0){
        if($table_status == 1 || $table_status == 3){
            echo "<h1>提交申请书</h1>";
            echo "<ul class='apply'>";
            echo "<li><a href='#' onclick='execute();'>&nbsp;&nbsp;&nbsp;&nbsp;通州区支持科技成果转化项目申报书</a></li>";
        }
    }
  ?>
