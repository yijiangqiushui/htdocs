...
<script type="text/javascript"
	src="../../../js/apply/attach_7/attach7_main.js"></script>
...
<body>
	<div class="default_left">
		<div class="menus">
			<h1>申报阶段</h1>
			<ul class="apply">
				<label>通州区支持技术输出能力提升项目申报书<span></span></label>
				<li><a href="org_info.html?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;通州区支持技术输出能力提升项目申报书</a><span></span></li>
    <?php
				if ($user_type == 0) {
					if ($table_status > 2) {
						// echo "<li><a href=\"Projectapp/project_check_opinion.php?status=". $table_status."&table_name="."项目实施方案"."\"".">&nbsp;&nbsp;&nbsp;&nbsp;1.14 审核意见</a><span></span></li>";
						echo "<li><a href=..\..\"check_opinion.php?status=" . $table_status . "&table_name='通州区支持技术输出能力提升项目申报书'\">&nbsp;&nbsp;&nbsp;&nbsp;审核意见</a><span></span></li>";
					}
				} else {
					// echo "<li><a href=\"Projectapp/project_check_opinion.php?status=". $table_status."&table_name="."项目实施方案"."\"".">&nbsp;&nbsp;&nbsp;&nbsp;1.14 审核意见</a><span></span></li>";
					echo "<li><a href=..\..\"check_opinion.php?status=" . $table_status . "&table_name='通州区支持技术输出能力提升项目申报书'\">&nbsp;&nbsp;&nbsp;&nbsp;审核意见</a><span></span></li>";
				...
				if ($user_type == 0) {
					if ($table_status == 1 || $table_status == 3) {
						echo "<h1>提交申请书</h1>";
						echo "<ul class='apply'>";
						echo "<li><a href='#' onclick='execute();'>&nbsp;&nbsp;&nbsp;&nbsp;通州区支持技术输出能力提升项目申报书</a></li>";
					}
				}
				?>
