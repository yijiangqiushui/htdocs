...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript"
        src="../../../js/projectapp/support_unit_opinion.js"></script>

    </head>

    <body>
        <form id="unit_opinion" method="post">
            <div class="project_content">
                ...
                <div class="table_content back-long">
                    <div class="basic_info bg_blue">
                        ...
                        <p class="title_top p-b10">推荐单位意见</p>
                        <div class="text_wrap">
                            <textarea name="unit_opinion" id="" class="text_content"></textarea>
                        </div>
