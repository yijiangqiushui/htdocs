...
<link href="../../../css/apply/attach8/attach8_main.css" rel="stylesheet" type="text/css" />
...
<script src="../../../js/apply/attach_8/attach8_main.js"></script>
...
<body>
	...
	<div class="func-bar">
		...
		<div class="menusNiframe">
			...
			<div class="menus">
				<ul>
                	<div class="menu-bar"><div>项目申报书</div></div>
					<li class="menu menu-unselected org_info clearfix">申报单位基本情况<div class="right pic hide"></div></li>
					
					
					<li class="menu menu-unselected check" id="opinion">审核意见</li>
					
					
                    <li class="menu menu-selected submit"id="sub" onclick="execute();"  >提交申报书</li>
				</ul>
			</div>
