...
<script type="text/javascript"
	src="../../../js/apply/attach_9/attach9_main.js"></script>
		...
		<div class="menus">
			...
			<ul class="apply">
				...
				<li style="list-style-type: none;"><a
					href="org_info.php?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;1.1
						基本信息</a><span></span></li>
				<li><a href="manager_team.html?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;1.2
						孵化场地及管理团队</a><span></span></li>
				<li><a href="manage_state.html?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;1.3
						经营状况</a><span></span></li>
				<li><a href="service.html?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;1.4
						服务能力</a><span></span></li>
				<li><a href="hatch.html?status=<?php echo $table_status?>">&nbsp;&nbsp;&nbsp;&nbsp;1.5
						孵化成效</a><span></span></li>
    <?php
				if ($user_type == 0) {
					if ($table_status > 2) {
						// echo "<li><a href=\"Projectapp/project_check_opinion.php?status=". $table_status."&table_name="."项目实施方案"."\"".">&nbsp;&nbsp;&nbsp;&nbsp;1.14 审核意见</a><span></span></li>";
						echo "<li><a href=..\..\"check_opinion.php?status=" . $table_status . "&table_name='通州区支持科技企业孵化器大学科技园发展项目申报书'\">&nbsp;&nbsp;&nbsp;&nbsp;审核意见</a><span></span></li>";
					}
				} else {
					// echo "<li><a href=\"Projectapp/project_check_opinion.php?status=". $table_status."&table_name="."项目实施方案"."\"".">&nbsp;&nbsp;&nbsp;&nbsp;1.14 审核意见</a><span></span></li>";
					echo "<li><a href=..\..\"check_opinion.php?status=" . $table_status . "&table_name='通州区支持科技企业孵化器大学科技园发展项目申报书'\">&nbsp;&nbsp;&nbsp;&nbsp;审核意见</a><span></span></li>";
				...
				if ($user_type == 0) {
					if ($table_status == 1 || $table_status == 3) {
						echo "<h1>提交申请书</h1>";
						echo "<ul class='apply'>";
						echo "<li><a href='#' onclick='execute();'>&nbsp;&nbsp;&nbsp;&nbsp;通州区支持科技企业孵化器大学科技园发展项目申报书</a></li>";
        }
    }
  ?>
