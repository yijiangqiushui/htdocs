...
<script type="text/javascript"
	src="../../../../js/check_material/authent.js"></script>
</head>

<body>
	<form id="authent" method="post">
		<div class="project_content">
			...
			<div class="table_content back-long">
				<div class="basic_info bg_blue">
					...
					<p class="title_top p-b10">项目实施过程中企业通过质量认证情况</p>
					<div class="text_wrap">
						<textarea name="quality_approve" id="" class="text_content" placeholder="项目单位通过何种认证，可填写xx年xx月通过xx质量认证"></textarea>
					</div>
