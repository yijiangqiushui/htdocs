...
<script type="text/javascript" src="../../../../../../../common/html/js/tablecommon.js"></script>
	<script type="text/javascript"
	src="../../../../js/check_material/org_info.js"></script>
			...
			<div class="table_content back-long">
				<table cellspacing="0" cellpadding="0" class="basic_info">
					...
					<tr>
						...
						<td colspan="5"><input name="register_address" readonly /></td>
					...
					<tr>
						...
						<td colspan="3"><input name="phone"  datatype="phandtel"/></td>
					</tr>
					<tr>
						<th><p align="center">职工总数（人）</p></th>
						<td><input name="staff_num"  datatype="number" placeholder='请输入整数'/></td>
						<th colspan="3"><p align="center">中级职称以上人数（人）</p></th>
						<td><input name="middel_pos" datatype="number" placeholder='请输入整数' /></td>
					</tr>
					<tr>
						<th><p align="center">单位年收入（万元）</p></th>
						<td><input name="year_income"  datatype="float" placeholder="请输入整数或小数"/></td>
						<th><p align="center">年利润 （万元）</p></th>
						<td><input name="year_profit"  datatype="float" placeholder="请输入整数或小数"/></td>
						<th><p align="center">年税金（万元）</p></th>
						<td><input name="year_tax" datatype="float" placeholder="请输入整数或小数" /></td>
					</tr>
				</table>
