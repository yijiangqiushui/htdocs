...
<script type="text/javascript" src="../../../../js/apply/work_summary/project_back.js"></script>
...
<body>
	<form method="post" id="project_back">
	<div class="project_content">
		<div class="table_title clearfix">
			<div class="title_pic left">专利实施工作总结报告</div>
			<div class="right back_pic" id="back"></div>
		</div>
		<div class="table_content back-long">
           <div class="basic_info bg_blue">
                <div class="title_top p-b10">项目立项背景和基本情况</div>
			
                <div class="subtitle">1、立项背景</div>
				<div class="text_wrap">
					<textarea class="text_content" name="project_back1" ></textarea>
				</div>
				
			
                <div class="subtitle">2、项目基本情况</div>
				<div class="text_wrap">
					<textarea class="text_content" name="project_back2" placeholder="1.项目实施目标 
2.项目主要研究开发内容
3.项目考核指标"></textarea>
    			</div>
