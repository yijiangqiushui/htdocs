...
<script type="text/javascript" src="../../../../js/apply/work_summary/project_detail.js"></script>
</head>
<body>
	<form method="post" id="project_detail">
	<div class="project_content">
		...
		<div class="table_content back-long">
            <!--  <table cellspacing="0" cellpadding="0" class="basic_info">
				...
				<tr>
                    <td colspan="7" class="border_left_none" style="background-color:#7AB5ED;">
                        <div class="title_top p-b10">课题实施过程中所作的具体工作</div>
					</td>
				</tr>
				<tr class="spe_row">
    				<td colspan="7">
    				
        				<textarea class="textarea_height" name="project_detail1">
        				</textarea>
            ...
            <div class="basic_info bg_blue">
				...
				<div class="text_wrap">
					<textarea class="text_content" name="project_detail1"></textarea>
				</div>
