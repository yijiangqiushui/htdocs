...
<script type="text/javascript" src="../../../../js/apply/work_summary/item_plan.js"></script>
</head>
<body>
	<form method="post" id="item_plan">
	<div class="project_content">
		<div class="table_title clearfix">
            ...
            <!--<table cellspacing="0" cellpadding="0" class="basic_info">
				...
				<tr>
                    <td colspan="7" class="border_left_none" style="background-color:#7AB5ED;">
                        <div class="title_top p-b10">课题实施过程经验总结及下一步工作计划</div>
					</td>
				</tr>
				<tr class="spe_row">
    				<td colspan="7">
        				<textarea class="textarea_height" name="item_plan1">
        				</textarea>
    				</td>
				</tr>
			...
			<div class="basic_info bg_blue">
				...
				<div class="text_wrap">
					<textarea class="text_content" name="item_plan1"></textarea>
				</div>
