...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="../../../../js/apply/attach3_patent/community_opinion.js"></script>
    </head>
    <body>
        <form method="post" id="community_opinion">
                    ...
                    <table cellspacing="0" cellpadding="0" class="basic_info">
                        ...
                        <tr>
                            <td colspan="7" class="border_left_none" style="background-color:#7AB5ED;">
                                <div class="title_top p-b10">七、区知识产权局审批意见</div>
                            </td>
                        </tr>
                        <tr class="spe_row">
                            <td colspan="7">
                                <textarea class="textarea_height" name="expert_opinion">
                                </textarea>
                                <br/>
