            ...
            <table cellspacing="0" cellpadding="0" class="basic_info">
				...
				<tr>
                    <td colspan="7" class="border_left_none" style="background-color:#7AB5ED;">
                        <div class="title_top p-b10">六、填表声明</div>
					</td>
				</tr>
				
				<tr class="spe_row">
				<td colspan="7">
				<p align="top">我单位保证上述填报内容及所提供的资料真实、完整、无误，如有不实，我单位承担由此引起的一切责任。</p>
				
				<p style="margin-top:400px"> <label style="float:right;"></label></p>
