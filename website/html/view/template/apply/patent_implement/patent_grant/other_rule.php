...
<script type="text/javascript" src="../../../../js/apply/patent_grant/other_rule.js"></script>

</head>

<body>
	<form id="other_rule" method="post">
		<div class="project_content">
			<div class="table_title clearfix">
				<div class="title_pic left">其他条款</div>
				<div class="right back_pic" id="back"></div>
			</div>
			<div class="table_content back-long">
				<div class="basic_info bg_blue">

					<p class="title_top p-b10">其他条款</p>
					

					<div class="text_wrap">
						<textarea name="other_condition" id="other_condition" class="text_content" >
						</textarea>
					</div>
