		...
		<div class="project_content">
			...
			<div class="table_content back-long">
				<div class="basic_info bg_blue">
					...
					<p class="subtitle">
						〔包括1、主要经济指标：如项目实施过程中所形成的市场规模、效益（包括销售收入、上缴税收、利润等）；2、主要技术指标：如项目实施过程中形成的新专利、标准、论文专著等数量及其水平等；3、项目实施过程所产生的社会效益；4、其他指标〕

					</p>

					<div class="text_wrap">
						<textarea name="" id="" class="text_content"></textarea>
					</div>
