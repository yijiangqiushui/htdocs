...
function bindEvents(){
	...
	$('.service_team').bind('click',function(){
		$('.iframe iframe').attr('src','service_team.html?table_status='+table_status+"&user_type="+user_type);
	});
	$('.manager').bind('click',function(){
		$('.iframe iframe').attr('src','manager.html?table_status='+table_status+"&user_type="+user_type);
	});
	...
	$('.service_thing').bind('click',function(){
		$('.iframe iframe').attr('src','service_thing.html?table_status='+table_status+"&user_type="+user_type);
	});
