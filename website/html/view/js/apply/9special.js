function submit_data(){
		$('#9special').form('submit' ,{
			url: '/modules/php/action/page/applycation/apply9.act.php?action=9special',
...
$(function()
	...
	function loadApplyInfo(){
		$.get('/modules/php/action/page/applycation/apply9.act.php?action=9findspecial',
		function(result){
			if(result!='0'){
				var res=eval("("+result+")");
				$('#9special').form('load',res);
			}
		});
