function submit_data(){
		$('#service_job').form('submit' ,{
			url: '/modules/php/action/page/applycation/apply9.act.php?action=9service_job',
...
$(function()
	...
	function loadApplyInfo(){
		$.get('/modules/php/action/page/applycation/apply9.act.php?action=9findservice_job',
		function(result){
			if(result!='0'){
				var res=eval("("+result+")");
