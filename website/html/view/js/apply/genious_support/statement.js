...
//页面自动加载
 ...
 function loadInfo(){
	 ...
	 $.get('/modules/php/action/page/genious/genious.act.php?action=find_support_statement',
				function(result) {
					if (result != '0') {
						var res = eval("(" + result + ")");
 ...
 function save_statement(){
	 $('#statement').form('submit',{
			url:'/modules/php/action/page/genious/genious.act.php?action=save_support_statement',
