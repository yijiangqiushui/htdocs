function unit_info(){
	$('#final_opinion').form('submit',{
		url:'../../../../../../../modules/php/action/page/lmcheck_material/check_material.act.php?action=save_final_opinion',
		success:function(result){
			...
			if(complete) {
				...
				window.parent.update_stage('final_opinion');
			}
...
function loadApplyInfo() {
	$.get('../../../../../../../modules/php/action/page/lmcheck_material/check_material.act.php?action=find_final_opinion',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
