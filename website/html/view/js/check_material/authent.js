function unit_info(){
	$('#authent').form('submit',{
		url:'../../../../../../../modules/php/action/page/lmcheck_material/check_material.act.php?action=save_authent',
		success:function(result){
			$.messager.alert('提示','信息保存成功！','info',function(){
			var complete = completeInput();   
			if(complete) {
				window.parent.save_stage('authent');
			}else{
				window.parent.update_stage('authent');
			}
			window.parent.setStep('authent',complete);
			});
		}
	});
