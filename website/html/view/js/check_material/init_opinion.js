function unit_info(){
	$('#unit_opinion').form('submit',{
		url:'../../../../../../../modules/php/action/page/lmcheck_material/check_material.act.php?action=save_unit_opinion',
		success:function(result){
			...
			if(complete) {
				...
				window.parent.update_stage('unit_opinion');
			}
...
function loadApplyInfo() {
	$.get('../../../../../../../modules/php/action/page/lmcheck_material/check_material.act.php?action=find_unit_opinion',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
