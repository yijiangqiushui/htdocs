function org_info(){
	$('#org_info').form('submit',{
		url:'../../../../../../../modules/php/action/page/applycation/attach4_patent.act.php?action=save_orginfo',
...
function loadApplyInfo() {
	$.get('../../../../../../../modules/php/action/page/applycation/attach4_patent.act.php?action=find_org_info',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
