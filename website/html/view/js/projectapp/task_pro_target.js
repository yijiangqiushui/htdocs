...
function pro_target() {
	$('#pro_target').form('submit',
					{
							url : '../../../../../modules/php/action/page/projectapp/projectapp.act.php?action=task_project_target',
...
function loadApplyInfo() {
	$.get( '../../../../../modules/php/action/page/projectapp/projectapp.act.php?action=findtask_ProTarget',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
