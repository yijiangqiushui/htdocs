function final_opinion(){
	$('#final_opinion').form('submit',{
		url:'/modules/php/action/page/genious/genious.act.php?action=savesupportfinal_opinion',
...
function loadApplyInfo() {
	$.get('/modules/php/action/page/genious/genious.act.php?action=support_findfinal_opinion',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
