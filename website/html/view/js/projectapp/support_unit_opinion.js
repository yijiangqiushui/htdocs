function unit_opinion(){
	$('#unit_opinion').form('submit',{
		url:'/modules/php/action/page/genious/genious.act.php?action=savesupportunit_opinion',
...
function loadApplyInfo() {
	$.get('/modules/php/action/page/genious/genious.act.php?action=support_findunit_opinion',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
