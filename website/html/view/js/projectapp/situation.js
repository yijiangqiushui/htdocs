function situation(){
	$('#situation').form('submit',{
		url:'/modules/php/action/page/genious/genious.act.php?action=savesituation',
		success:function(result){
			...
			if(complete) {
				...
				window.parent.update_stage('situation');
			}
...
function loadApplyInfo() {
	$.get('/modules/php/action/page/genious/genious.act.php?action=findsituation',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
