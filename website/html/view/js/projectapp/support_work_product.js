function work_product(){
	$('#work_product').form('submit',{
		url:'/modules/php/action/page/genious/genious.act.php?action=savesupportwork_product',
...
function loadApplyInfo() {
	$.get('/modules/php/action/page/genious/genious.act.php?action=support_findwork_product',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
