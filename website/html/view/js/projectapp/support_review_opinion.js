function review_opinion(){
	$('#review_opinion').form('submit',{
		url:'/modules/php/action/page/genious/genious.act.php?action=savesupportreview_opinion',
...
function loadApplyInfo() {
	$.get('/modules/php/action/page/genious/genious.act.php?action=support_findreview_opinion',
					function(result) {
						if (result != '0') {
							var res = eval("(" + result + ")");
