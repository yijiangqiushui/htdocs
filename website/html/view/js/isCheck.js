...
$(function(){
	$('#datagrid').datagrid({
		...
		remoteSort : false,
		url:'../../../php/action/page/isNotCheck.act.php?action=queryNotCheck&flag=1',//url调用Action方法
		columns:[[
			...
			{field:'action',title:'操作',width:200,align:'center',
				formatter:function(value,row,index){							
					...
					var b='|'+'<a href="javascript:void(0)" onclick="printForm('+row.id+')">打印表单</a>';						
					/*var rn='';
					if(pridge=='super'){
							rn=a+b;
					}else{
...
function printForm(id){
	window.open('../../../../modules/php/action/page/printPdf.php?action=printPdf&id='+id);
}