...
insert  into `admininfo`(`id`,`department`,`user_type`,`username`,`password`,`realname`,`phone`,`email`,`qq`,`isForbidden`,`addDate`,`lastIP`,`isDel`,`ntid`,`seed`,`lastLoginTime`) values (1,0,3,'super','592d510020d3eacdc3d5c89e2e148f7467de3e82','超级管理员','13774774787','22@gmail.com','11111',0,NULL,'221.221.4.116',NULL,NULL,NULL,'2015-12-16 11:14:06'),(5,0,1,'suy','592d510020d3eacdc3d5c89e2e148f7467de3e82','苏颖','13774774787','suying@qq.com','19874568785',0,NULL,NULL,0,NULL,NULL,NULL),(6,0,1,'kangly','592d510020d3eacdc3d5c89e2e148f7467de3e82','康连元','15487895624','kanglianyuan@qq.com','7458452',0,NULL,NULL,0,NULL,NULL,NULL),(7,1,1,'gengdl','592d510020d3eacdc3d5c89e2e148f7467de3e82','耿大乐','13487784521','gengdale@qq.com','8521354',0,NULL,NULL,0,NULL,NULL,NULL),(8,1,1,'guohj','592d510020d3eacdc3d5c89e2e148f7467de3e82','郭华杰','18956532549','guohuajie@qq.com','45123354',0,NULL,NULL,0,NULL,NULL,NULL),(9,2,1,'songlj','592d510020d3eacdc3d5c89e2e148f7467de3e82','宋李杰','13654897856','songlijie@qq.com','1554895645',0,NULL,NULL,0,NULL,NULL,NULL),(10,2,1,'jinz','592d510020d3eacdc3d5c89e2e148f7467de3e82','金竹','15458956532','jinzhu@qq.com','5451345455',0,NULL,NULL,0,NULL,NULL,NULL),(11,2,1,'wangzh','592d510020d3eacdc3d5c89e2e148f7467de3e82','王振海','18745895456','wangzhenghai@qq.com','45512645312',0,NULL,NULL,0,NULL,NULL,NULL);
...
insert  into `project_ann_plan`(`id`,`project_id`,`plan_year`,`plan_content`) values (73,'dev1449884706','2014','2.	设计思路\r\n通州区科委在线申报及科技项目查新平台设计思路应是：围绕申报管理办法，以方便科委内部申报管理工作，增进工作效率为核心，以方便申报单位的数据报送为主要目的；经济实用、快速见效；以需求为导向、以应用促发展；数据交换、资源共享。\r\n对于系统的设计必须要与申报管理实施办法相适应，所有对于系统的设计必须以申报管理办法为最高原则，在此基础上充分考虑系统的可扩展性。\r\n1.	以方便科委内部的管理'),(74,'dev1449884706','2015','2.	设计思路\r\n通州区科委在线申报及科技项目查新平台设计思路应是：围绕申报管理办法，以方便科委内部申报管理工作，增进工作效率为核心，以方便申报单位的数据报送为主要目的；经济实用、快速见效；以需求为导向、以应用促发展；数据交换、资源共享。\r\n对于系统的设计必须要与申报管理实施办法相适应，所有对于系统的设计必须以申报管理办法为最高原则，在此基础上充分考虑系统的可扩展性。\r\n1.	以方便科委内部的管理'),(75,'dev1449884706','2016','2.	设计思路\r\n通州区科委在线申报及科技项目查新平台设计思路应是：围绕申报管理办法，以方便科委内部申报管理工作，增进工作效率为核心，以方便申报单位的数据报送为主要目的；经济实用、快速见效；以需求为导向、以应用促发展；数据交换、资源共享。\r\n对于系统的设计必须要与申报管理实施办法相适应，所有对于系统的设计必须以申报管理办法为最高原则，在此基础上充分考虑系统的可扩展性。\r\n1.	以方便科委内部的管理'),(76,'dev1449990507','2013','2013年目标'),(77,'dev1449990507','2014','2014年目标'),(78,'dev1449990507','2015','2015年目标'),(82,'dev1449993220','2001','项目各年度任务目标、考核指标及研究开发内容完成的计划进度'),(83,'dev1449993220','2002','项目各年度任务目标、考核指标及研究开发内容完成的计划进度'),(84,'dev1449993220','2003','项目各年度任务目标、考核指标及研究开发内容完成的计划进度'),(85,'dev1449993371','1','1'),(86,'dev1449993371','1','11'),(87,'dev1449993371','1','1'),(88,'dev1450227229','2012','fv  '),(89,'dev1450227229','2199','ff '),(90,'dev1450227229','2344','发愤忘食'),(91,'dev1450227541','2011','奥'),(92,'dev1450227541','2012','好'),(93,'dev1450227541','2013','好');
