...
switch($_GET['action']){
	...
	case 'getDateGrid':
		...
		$file=new makeFile();
		$file->getDateGrid($_POST['page'],$_POST['rows'],$_POST['upper_cat'],$_POST['beginDate'],$_POST['endDate'],$_POST['file_name'],$_POST['file_no'],$_POST['flag1'],$file_self,$_POST['file_type'],$_POST['author']);	
