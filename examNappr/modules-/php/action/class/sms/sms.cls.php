		...
		if(count($arr)===0){
			...
			for($i=0;$i<count($arr);$i++){
				...
				*/
				...
				$arr2[$i]=array('id'=>$arr[$i]['id'],'smsPhone'=>$smsPhone,'smsName'=>$sendName,'content'=>$arr[$i]['content'],'isSent'=>$isSent_str,'Sent'=>$arr[$i]['isSent'],'sendtime'=>$arr[$i]['sendtime'],'faileSent'=>$faileSent,'admin_id'=>$arr[$i]['admin_id']);		
