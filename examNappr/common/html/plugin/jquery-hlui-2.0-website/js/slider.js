...
$.extend({
    ...
    <div class="ui-slider-bar" style="background-color:'+config.barColor+'; border:1px solid '+config.barColor+'; width:0;"></div>\
    <div class="ui-slider-dragger"></div>\
		...
		$('#'+config.id+' .ui-slider-bar').css('width',config.val*100+'%');
		$('#'+config.id+' .ui-slider-dragger').css('left',config.val*100+'%');
	},
