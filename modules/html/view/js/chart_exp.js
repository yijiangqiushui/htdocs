...
//按学位 柱状图显示
function column_degree_exp(){
	$.get('../../../php/action/page/chart/chart.act.php?action=degree_exp',function(data){
		var data=eval('('+data+')');
		var xline=[];
		var source=[];
...
//按研究方向 柱状图显示
function column_research_exp(){
	$.get('../../../php/action/page/chart/chart.act.php?action=research_exp',function(data){
		var data=eval('('+data+')');
		var xline=[];
		var source=[];
		for(var i=0;i<data.length;i++){
...
//按职称 柱状图显示
function column_work_exp(){
	$.get('../../../php/action/page/chart/chart.act.php?action=work_exp',function(data){
...
//按性别比例 柱状图显示
function column_scale_exp(){
	$.get('../../../php/action/page/chart/chart.act.php?action=scale_exp',function(data){
		var data=eval('('+data+')');
		var xline=['男','女'];
